...
这是 `projects/jeecgboot-page-agent-demo/` 前端 demo 对应的 JEECG Boot 后端。

## 目录关系

```text
projects/
  jeecgboot-page-agent-demo/          # Vue3 前端，已顶层挂载 PageAgent Web Chat
  jeecgboot-page-agent-demo-backend/  # Spring Boot 后端，提供登录、菜单、业务接口
```
...
```bash
cd projects/jeecgboot-page-agent-demo-backend
...
```bash
cd projects/jeecgboot-page-agent-demo
pnpm install
